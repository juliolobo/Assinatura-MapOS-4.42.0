        ...
        <div class="widget-box">
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <div class="buttons">
                    ...
                    <a title="Assinar" class="btn btn-mini btn-primary" href="<?php echo site_url() ?>/mine/detalhesos/<?php echo $result->idOs .'?tab=5'; ?>" style="margin-left:10px"><i class="fas fa-pencil-alt"></i> Assinar</a>
                </div>
            </div>
